...
<script type="text/javascript">
var CCom = "${forwardPayment.forwardPaymentConfiguration.merchantId}" // "966000100100000010009"; // Número do cartão do comerciante
var A001 = "${forwardPayment.forwardPaymentConfiguration.virtualTPAId}" // "2796"; // Número do TPA Virtual
...
function submitPayment(C007, A061, C046, C012, iFrame, popup, popupHeight, popupWidth){
	var A030 = "<%= TPAVirtualImplementation.AUTHENTICATION_REQUEST_MESSAGE %>"; // Código de Mensagem
...
$(document).ready(function() {
	submitPaymentByFrame('${forwardPayment.orderNumber}', '${forwardPayment.formattedAmount}', '', '${forwardPayment.returnURL}');
});
</script>

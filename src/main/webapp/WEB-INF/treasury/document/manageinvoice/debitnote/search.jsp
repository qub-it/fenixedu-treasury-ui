...
<div class="page-header">
	<h1>
		<spring:message code="label.document.manageInvoice.searchDebitNote" />
		<small></small>
	</h1>
</div>
<%-- NAVIGATION --%>
	...
	<form method="get" class="form-horizontal">
		<div class="panel-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input id="debitNote_documentNumber" class="form-control" type="text" name="documentnumber"
...
<c:choose>
	<c:when test="${not empty searchdebitnoteResultsDataSet}">
		...
		<datatables:table id="searchdebitnoteTable" row="debitNote" data="${searchdebitnoteResultsDataSet}" cssClass="table responsive table-bordered table-hover" cdn="false"
			cellspacing="2">
			<datatables:column>
...
<%-- 				<c:out value="${debitNote.documentDate}" /> --%>
			...
			<datatables:column>
				<!--  ACTIONS COLUMN -->
				<a class="btn btn-default btn-xs" href="${pageContext.request.contextPath}/treasury/document/manageinvoice/debitnote/search/view/${debitNote.externalId}"> <spring:message
						code='label.view' /></a>
			</datatables:column>
		</datatables:table>
		<script>

...
<div class="page-header">
    <h1>
        <spring:message
            code="label.document.manageInvoice.searchCreditNote" />
        <small></small>
    </h1>
</div>
        ...
        <div class="panel-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <select id="creditNote_debtAccount"
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.CreditNote.documentNumber" />
                </div>

                <div class="col-sm-10">
                    <input id="creditNote_documentNumber"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <select id="creditNote_state" class="form-control"
                        name="state">
                        <option value="">&nbsp;</option>
...
<c:if test="${limit_exceeded}">
    <div class="alert alert-warning" role="alert">
        ...
        <p>
            ...
            <spring:message code="label.limitexceeded" arguments="${searchcreditnoteResultsDataSet.size()};${searchcreditnoteResultsDataSet_totalCount}" argumentSeparator=";"
                htmlEscape="false" />
        </p>
    ...
    <c:when test="${not empty searchcreditnoteResultsDataSet}">
        ...
        <datatables:table id="searchcreditnoteTable" row="creditNote"
            ...
            <datatables:column>
                ...
                <c:out value='${creditNote.documentDate.toString("YYYY-MM-dd HH:mm")}' />
<%--                 <joda:format value="${creditNote.documentDate}" style="S-" /> --%>
            ...
            <datatables:column>
                ...
                <a class="btn btn-default btn-xs"
                    href="${pageContext.request.contextPath}/treasury/document/manageinvoice/creditnote/search/view/${creditNote.externalId}">

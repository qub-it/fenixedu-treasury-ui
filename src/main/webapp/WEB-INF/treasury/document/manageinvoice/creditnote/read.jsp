...
<div class="page-header">
    <h1>
        <spring:message
            code="label.document.manageInvoice.readCreditNote" />
        <small></small>
    </h1>
</div>
<div class="modal fade" id="deleteModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteForm"
                action="${pageContext.request.contextPath}/treasury/document/manageinvoice/creditnote/delete/${creditNote.externalId}"
                method="POST">
                ...
                <div class="modal-body">
                    <p>
                        <spring:message
                            code="label.document.manageInvoice.readCreditNote.confirmDelete" />
                    </p>
                </div>
...
<div class="modal fade" id="closeModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteForm"
                action="${pageContext.request.contextPath}/treasury/document/manageinvoice/creditnote/read/${creditNote.externalId}/closecreditnote"
                method="POST">
                <div class="modal-header">
                    <button type="button" class="close"
                        data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <p>
                        <spring:message
                            code="label.document.manageInvoice.readCreditNote.confirmClose" />
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default"
...
<div class="modal fade" id="anullModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteForm"
                action="${pageContext.request.contextPath}/treasury/document/manageinvoice/creditnote/read/${creditNote.externalId}/anullcreditnote"
                method="POST">
                <div class="modal-header">
                    <button type="button" class="close"
                        data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <p>
                        <spring:message
                            code="label.document.manageInvoice.readCreditNote.confirmAnull" />
                    </p>
                    <div class="form">
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <spring:message
                                    code="label.CreditNote.annulledReason" />
                            </div>

                            <div class="col-sm-8">
                                <input id="CreditNote_anullReason"
        ...
        <c:if test="${creditNote.isPreparing()}">
            ...
            <a class="" href="#" data-toggle="modal"
                data-target="#closeModal"> <spring:message
                    code="label.event.document.manageInvoice.closeCreditNote" />
            </a> &nbsp; 
		</c:if>
            ...
            <table class="table">
                <tbody>
                    <tr>
                        ...
                        <td><c:out
                                value='${creditNote.documentNumberSeries.series.finantialInstitution.name}' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.DebtAccount.customer" /></th>
                        <td><c:out
                                value='${creditNote.debtAccount.customer.businessIdentification} - ${creditNote.debtAccount.customer.name}' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.CreditNote.documentNumber" /></th>
                        <td><c:out
                                value='${creditNote.uiDocumentNumber}' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.CreditNote.documentDate" /></th>
                        <td><joda:format
                                value="${creditNote.documentDate}"
                                style="S-" /></td>
                    </tr>
                    <c:if
                        test="${not empty  creditNote.originDocumentNumber}">
                        <tr>
                            <th scope="row" class="col-xs-3"><spring:message
                                    code="label.CreditNote.originDocumentNumber" /></th>
                            <td><c:out
                                    value='${creditNote.originDocumentNumber}' /></td>
                        </tr>
                    </c:if>
                    <c:if
                        test="${not empty  creditNote.documentObservations}">
                        <tr>
                            <th scope="row" class="col-xs-3"><spring:message
                                    code="label.CreditNote.documentObservations" /></th>
                            <td><c:out
                                    value='${creditNote.documentObservations}' /></td>
                        </tr>
                    </c:if>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                        ...
                        <td><c:if
                                ...
                                <a
                                    href="${pageContext.request.contextPath}/treasury/document/manageinvoice/debitnote/read/${creditNote.getDebitNote().externalId}"><c:out
                                        value='${creditNote.getDebitNote().uiDocumentNumber}' /></a>
                            </c:if></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.CreditNote.state" /></th>
                        <td><c:if test="${creditNote.isAnnulled()}">
                                ...
                                value='${creditNote.state.descriptionI18N.content}' />
                            </span></td>
                    </tr>
                    <c:if test="${creditNote.isAnnulled()}">
                        <tr>
                            <th scope="row" class="col-xs-3"><spring:message
                                    code="label.CreditNote.annulledReason" /></th>
                            <td><c:out
                                    value='${creditNote.annulledReason}' /></td>
                        </tr>
                    </c:if>
                    ...
                    <tr>
                        ...
                        <td><c:out
                                value='${creditNote.debtAccount.finantialInstitution.currency.getValueFor(creditNote.totalNetAmount)}' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.DebitNote.totalVatAmount" /></th>
                        <td><c:out
                                value='${creditNote.debtAccount.finantialInstitution.currency.getValueFor(creditNote.totalVatAmount)}' /></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><c:out
                                value='${creditNote.debtAccount.finantialInstitution.currency.getValueFor(creditNote.totalAmount)}' /></td>
                    </tr>

                    <c:if
                        test="${not empty creditNote.relatedSettlementEntries }">
                        <tr>
                            <th scope="row" class="col-xs-3"><spring:message
...
<c:choose>
    <c:when test="${not empty creditNote.creditEntriesSet}">
        <datatables:table id="creditEntries" row="creditEntry"
            data="${creditNote.creditEntriesSet}"
            ...
            <datatables:column cssStyle="width:10%">
                ...
                <c:out
                    value="${creditEntry.currency.getValueFor(creditEntry.totalAmount)}" />
            </datatables:column>
            <datatables:column cssStyle="width:10%">
                <datatables:columnHead>
            ...
            <datatables:column cssStyle="width:10%">
                <form method="get"
                    action="${pageContext.request.contextPath}/treasury/document/manageinvoice/creditentry/read/${creditEntry.externalId}">

...
<div class="page-header">
    <h1>
        <spring:message
            code="label.document.manageInvoice.createCreditEntry" />
        <small></small>
    </h1>
</div>
<%-- NAVIGATION --%>
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
        class=""
        href="${pageContext.request.contextPath}/treasury/document/manageinvoice/creditnote/read/${creditEntryBean.finantialDocument.externalId}"><spring:message
...
<form name='form' method="post" class="form-horizontal"
    ng-app="angularAppCreditEntry" ng-controller="CreditEntryController"
    ...
    <input type="hidden" name="postback"
        value='${pageContext.request.contextPath}/treasury/document/manageinvoice/creditentry/createpostback' />
        ...
        <div class="panel-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-control">
                        <c:out
                            value="${creditEntryBean.debtAccount.finantialInstitution.name}" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-control">
                        <c:out
                            value="${creditEntryBean.debtAccount.customer.businessIdentification} - ${creditEntryBean.debtAccount.customer.name}" />
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.CreditEntry.finantialDocument" />
                </div>

                <div class="col-sm-10">
                    <div class="form-control">
                        <c:if
                            test="${not empty creditEntryBean.finantialDocument}">
                            <c:out
                                value='${creditEntryBean.finantialDocument.uiDocumentNumber}' />
                        </c:if>
                        <c:if
                            test="${empty creditEntryBean.finantialDocument}">
                            <spring:message
                                code="label.CreditEntry.creditentry.with.no.document" />
                        </c:if>
                    </div>
                </div>
            </div>
        ...
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <ui-select id="creditEntry_product" name="product"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input id="creditEntry_description"
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <div class="input-group-addon">
                            <c:out
                                value="${creditEntryBean.debtAccount.finantialInstitution.currency.symbol}" />
                        </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input id="creditEntry_quantity"
                        class="form-control" type="text"
                        ng-model="object.quantity" name="quantity" />
                </div>
            </div>

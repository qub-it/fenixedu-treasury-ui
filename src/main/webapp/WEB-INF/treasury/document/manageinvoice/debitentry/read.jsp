...
<div class="page-header">
    <h1>
        <spring:message
            code="label.document.manageInvoice.readDebitEntry" />
        <small></small>
    </h1>
</div>
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><joda:format
                                value="${debitEntry.entryDateTime}"
                                style="SS" /> <%--                         <c:out value='${debitEntry.entryDateTime}' /> --%></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                    ...
                    <tr>
                        ...
                        <td><c:out
                                value='${debitEntry.vat.taxRate} % ' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message

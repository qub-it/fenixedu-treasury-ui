...
<div class="page-header">
    <h1>
        <spring:message
            code="label.document.manageInvoice.updateDebitEntry" />
        <small></small>
    </h1>
</div>
...
<form name='form' method="post" class="form-horizontal"
    ...
    <input type="hidden" name="postback"
        value='${pageContext.request.contextPath}treasury/document/manageinvoice/debitentry/updatepostback/${debitEntry.externalId}' />
        ...
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-control">
                        <c:if
                            test="${not empty debitEntry.finantialDocument}">
                            <c:out
                                value='${debitEntry.finantialDocument.uiDocumentNumber}' />
                        </c:if>
                        <c:if
                            test="${empty debitEntry.finantialDocument}">
                            <spring:message
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.FinantialDocumentEntry.entryDateTime" />
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-control">
                        <c:out
                            value="${debitEntryBean.product.name.content}" />
                    </div>
                </div>
            </div>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <ui-select ng-model="$parent.object.treasuryEvent"
                        theme="bootstrap" ng-disabled="disabled">
                    <ui-select-match>{{$select.selected.text}}</ui-select-match>
                    <ui-select-choices
                        repeat="event.id as event in eventsDataSource| filter: $select.search">
                    <span
                        ng-bind-html="event.text | highlight: $select.search"></span>

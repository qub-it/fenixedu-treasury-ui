...
${portal.toolkit()} ${portal.angularToolkit()}
...
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
        class=""
        href="${pageContext.request.contextPath}/<%= DebtAccountController.READ_URL %>${settlementNoteBean.debtAccount.externalId}"><spring:message
...
<div>
    <p>
        <b>1. <spring:message
                code="label.administration.manageCustomer.createSettlementNote.chooseInvoiceEntries" /></b>
...
<form name='form' method="post" class="form-horizontal"
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <p>
                <spring:message
                    code="label.SettlementNote.headerDetails" />
            </p>
        </div>
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <ui-select id="settlementNote_documentNumberSeries"
                        ng-model="$parent.object.docNumSeries"
                        theme="bootstrap" ng-disabled="disabled"
                        ng-required> <ui-select-match>{{$select.selected.text}}</ui-select-match>
                    <ui-select-choices
                        repeat="docNumSeries.id as docNumSeries in object.documentNumberSeries | filter: $select.search">
                    <span ng-bind-html="docNumSeries.text"></span> </ui-select-choices> </ui-select>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                ...
                <div class="col-sm-4">
                    <input class="form-control" type="text"
                        ng-model="object.originDocumentNumber" />
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    <c:forEach
                        ...
                        <td><span
                            ...
                            ng-show="object.debitEntries[${ loop.index }].isNotValid"></span>
                            <input class="form-control"
                            ng-model="object.debitEntries[${ loop.index }].isIncluded"
                            type="checkbox" /></td>
                        <td><c:out
                        ...
                        <td><c:out
                                value="${ settlementNoteBean.debtAccount.finantialInstitution.currency.getValueFor( debitEntryBean.debitEntry.amountWithVat ) }" /></td>
                        <td><c:out
                                value="${ settlementNoteBean.debtAccount.finantialInstitution.currency.getValueFor( debitEntryBean.debitEntry.openAmount ) }" /></td>
                        <td><c:out
                                value="${ debitEntryBean.debitEntry.vat.taxRate }" /></td>
                        <c:if
                            ...
                            <td>
                                <div class="input-group col-sm-12">
                                    ...
                                    <input class="form-control"
                                        name="debtAmount${ loop.index }"
                                        ng-model="object.debitEntries[${ loop.index }].debtAmount"
                                        type="text"
                                        ng-disabled="!object.debitEntries[${ loop.index }].isIncluded"
                                        ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/"
                                        value='0.00' />
                                </div>
                                <p class="alert alert-danger"
                                    ng-show="form.debtAmount${ loop.index }.$error.pattern && object.debitEntries[${ loop.index }].isIncluded">
                                    <spring:message
                        ...
                        <c:if
                            ...
                            <td><c:out
                                    value="${ settlementNoteBean.debtAccount.finantialInstitution.currency.getValueFor( debitEntryBean.debtAmount ) }"></c:out></td>
                        </c:if>
                        </tr>
                    </c:forEach>
                </tbody>
            ...
            <table id="creditEntriesTable"
                ...
                <thead>
                    <tr>
                        ...
                        <th></th>
                        <th class="col-sm-2"><spring:message
                                code="label.CreditEntry.documentNumber" /></th>
                        <th><spring:message
                                code="label.CreditEntry.motive" /></th>
                        <th class="col-sm-1"><spring:message
                                code="label.CreditEntry.date" /></th>
                        <th class="col-sm-1"><spring:message
                                code="label.DebitEntry.vat" /></th>
                        <th class="col-sm-2"><spring:message
                                code="label.CreditEntry.totalAmount" /></th>
                    </tr>
                </thead>
                <tbody>
                    <c:forEach
                        ...
                        <tr>
                            <td><input class="form-control"
                                ng-model="object.creditEntries[${ loop.index }].isIncluded"
                                type="checkbox" /></td>
                            <td><c:out
                            ...
                            <td><c:out
                                    value="${ creditEntryBean.creditEntry.vat.taxRate }" /></td>
                            <td>- <c:out

...
<div class="page-header">
	<h1><spring:message code="label.document.managePayments.searchSettlementNote" />
		<small></small>
	</h1>
</div>
<%-- NAVIGATION --%>
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/document/managepayments/settlementnote/create"   ><spring:message code="label.event.create" /></a>
|&nbsp;&nbsp;</div>
...
<c:choose>
	<c:when test="${not empty searchsettlementnoteResultsDataSet}">
		<table id="searchsettlementnoteTable" class="table responsive table-bordered table-hover">
			<thead>
				<tr>
					<%--!!!  Field names here --%>
<th><spring:message code="label.SettlementNote.finantialDocumentType"/></th>
<th><spring:message code="label.SettlementNote.debtAccount"/></th>
<th><spring:message code="label.SettlementNote.documentNumberSeries"/></th>
<th><spring:message code="label.SettlementNote.currency"/></th>
<th><spring:message code="label.SettlementNote.documentNumber"/></th>
<th><spring:message code="label.SettlementNote.documentDate"/></th>
<th><spring:message code="label.SettlementNote.documentDueDate"/></th>
<th><spring:message code="label.SettlementNote.originDocumentNumber"/></th>
<th><spring:message code="label.SettlementNote.state"/></th>
<%-- Operations Column --%>
					<th></th>
				</tr>
			</thead>
...
" <a  class=\"btn btn-default btn-xs\" href=\"${pageContext.request.contextPath}/treasury/document/managepayments/settlementnote/search/view/${searchResult.externalId}\"><spring:message code='label.view'/></a>" +
	...
	$("#settlementNote_finantialDocumentType").select2(
		{
		    ...
		    $("#settlementNote_finantialDocumentType").select2().select2('val', '<c:out value='${param.finantialDocumentType}'/>');
	...
	<%-- End block for providing currency options --%>
		...
		var table = $('#searchsettlementnoteTable').DataTable({language : {

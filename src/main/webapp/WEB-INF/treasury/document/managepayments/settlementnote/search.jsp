...
<div class="page-header">
    <h1>
        <spring:message code="label.document.managePayments.searchSettlementNote" />
        <small></small>
    </h1>
</div>
<%-- NAVIGATION --%>
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>&nbsp;<a class=""
        href="${pageContext.request.contextPath}/treasury/document/managepayments/settlementnote/create"><spring:message code="label.event.create" /></a> &nbsp;|&nbsp;
</div>
    ...
    <form method="get" class="form-horizontal">
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input id="settlementNote_documentNumber" class="form-control" type="text" name="documentnumber"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input id="settlementNote_documentDate" class="form-control" type="text" name="documentdate" bennu-date

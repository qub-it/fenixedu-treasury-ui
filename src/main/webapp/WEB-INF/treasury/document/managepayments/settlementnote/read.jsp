...
<div class="page-header">
	<h1><spring:message code="label.document.managePayments.readSettlementNote" />
		<small></small>
	</h1>
</div>
  ...
  <div class="modal-dialog">
    ...
    <form id ="deleteForm" action="${pageContext.request.contextPath}/treasury/document/managepayments/settlementnote/delete/${settlementNote.externalId}"   method="POST">
      ...
      <div class="modal-body">
        <p><spring:message code = "label.document.managePayments.readSettlementNote.confirmDelete"/></p>
      </div>
...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/document/managepayments/settlementnote/"  ><spring:message code="label.event.back" /></a>
...
data-target="#deleteModal"><spring:message code="label.event.delete" /></a>
				|&nbsp;&nbsp;
	<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/document/managepayments/settlementnote/update/${settlementNote.externalId}"  ><spring:message code="label.event.update" /></a>
|&nbsp;&nbsp;</div>

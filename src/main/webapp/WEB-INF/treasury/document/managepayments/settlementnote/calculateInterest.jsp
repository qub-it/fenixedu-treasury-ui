...
<div>
    <p>
        ...
        <b>2. <spring:message code="label.administration.manageCustomer.createSettlementNote.calculateInterest" /></b>
        <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span>
...
<form id='calculateInterestForm' name='form' method="post" class="form-horizontal"
    ...
    <div class="panel panel-primary">    
            ...
            <table id="debitEntriesTable"
                ...
                <tbody>
                    <c:forEach items="${ settlementNoteBean.interestEntries}" var="interestEntryBean" varStatus="loop">
                        <tr>  
                            <td>
                                <input class="form-control" ng-model="object.interestEntries[${ loop.index }].isIncluded" type="checkbox" />
                            </td>
                            <td>
        ...
        <div class="panel-footer">
            <button type="button" class="btn btn-default" onClick="javascript:processSubmit('${pageContext.request.contextPath}<%= SettlementNoteController.CHOOSE_INVOICE_ENTRIES_URL %>${settlementNoteBean.debtAccount.externalId}')"><spring:message code="label.event.back" /></button>
            <button type="button" class="btn btn-primary" onClick="javascript:processSubmit('${pageContext.request.contextPath}<%= SettlementNoteController.CALCULATE_INTEREST_URL %>')"><spring:message code="label.continue" /></button>
        </div>
    </div>    
</form>

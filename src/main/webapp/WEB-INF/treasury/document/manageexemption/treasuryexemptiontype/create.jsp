...
<div class="page-header">
	<h1>
		<spring:message
			code="label.document.manageExemption.createTreasuryExemptionType" />
		<small></small>
	</h1>
</div>
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input id="treasuryExemptionType_code" class="form-control" type="text"
						name="code"
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input id="treasuryExemptionType_name" class="form-control" type="text"

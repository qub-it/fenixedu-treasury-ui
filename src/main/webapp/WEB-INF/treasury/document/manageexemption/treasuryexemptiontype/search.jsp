...
<div class="page-header">
	<h1>
		<spring:message
			code="label.document.manageExemption.searchTreasuryExemptionType" />
		<small></small>
	</h1>
</div>
<%-- NAVIGATION --%>
...
<!-- <div class="col-sm-10"> -->
<%-- 	<input id="treasuryExemptionType_code" class="form-control" type="text" name="code"  value='<c:out value='${not empty param.code ? param.code : treasuryExemptionType.code }'/>' /> --%>
<!-- </div>	 -->
<!-- </div>		 -->
<!-- <div class="form-group row"> -->
...
<!-- <div class="col-sm-10"> -->
<%-- 	<input id="treasuryExemptionType_discountRate" class="form-control" type="text" name="defaultExemptionPercentage"  value='<c:out value='${not empty param.defaultexemptionpercentage ? param.defaultexemptionpercentage : treasuryExemptionType.defaultExemptionPercentage }'/>' /> --%>
<!-- </div>	 -->
<!-- </div>		 -->
<!-- </div> -->
...
<script>
	var searchtreasuryexemptiontypeDataSet = [
			<c:forEach items="${searchtreasuryexemptiontypeResultsDataSet}" var="searchResult">
...
" <a  class=\"btn btn-default btn-xs\" href=\"${pageContext.request.contextPath}/treasury/document/manageexemption/treasuryexemptiontype/search/view/${searchResult.externalId}\"><spring:message code='label.view'/></a>" +
	...
	$(document).ready(function() {
		...
		var table = $('#searchtreasuryexemptiontypeTable').DataTable({language : {
		...
		"data" : searchtreasuryexemptiontypeDataSet,
...
//"dom": '<"col-sm-6"l>rtip', // FilterBox = NO && ExportOptions = NO
		...
		table.columns.adjust().draw();
		  ...
		  $('#searchtreasuryexemptiontypeTable tbody').on( 'click', 'tr', function () {

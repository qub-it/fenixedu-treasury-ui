...
<div class="page-header">
    <h1>
        <spring:message
            code="label.integration.erp.readERPImportOperation" />
        <small></small>
    </h1>
</div>
<div class="modal fade" id="deleteModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteForm"
                action="${pageContext.request.contextPath}/treasury/integration/erp/erpimportoperation/delete/${eRPImportOperation.externalId}"
                method="POST">
                ...
                <div class="modal-body">
                    <p>
                        <spring:message
                            code="label.integration.erp.readERPImportOperation.confirmDelete" />
                    </p>
                </div>
...
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
        class=""
        href="${pageContext.request.contextPath}/treasury/integration/erp/erpimportoperation/"><spring:message
                ...
                <tbody>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.ERPImportOperation.executionDate" /></th>
                        <td><joda:format
                                value='${eRPImportOperation.executionDate}' style='SS' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.ERPImportOperation.executor" /></th>
                        <td><c:out
                                value='${eRPImportOperation.versioningCreator}' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.ERPImportOperation.finantialInstitution" /></th>
                        <td><c:out
                                value='${eRPImportOperation.finantialInstitution.name}' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.ERPImportOperation.success" /></th>
                        <td><c:if
                                test="${eRPImportOperation.success}">
                                <span class="label label-primary">
                                    <spring:message code="label.true" />
                                </span>
                            </c:if> <c:if
                                test="${not eRPImportOperation.success}">
                    ...
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.ERPImportOperation.errorLog" /></th>
                        <td><c:out
                                value='${eRPImportOperation.errorLog}' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.ERPImportOperation.integrationLog" /></th>
                        <td><c:out
                                value='${eRPImportOperation.integrationLog}' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.ERPImportOperation.finantialDocuments" /></th>
                        <td>
                            <ul>
                                <c:forEach
                                    items="${eRPImportOperation.finantialDocuments}"
                                    var="element">
                                    <li><c:out value="${element}" />
                                        <%-- CHANGE_ME --%></li>
                                </c:forEach>
                                <ul>
                        </td>

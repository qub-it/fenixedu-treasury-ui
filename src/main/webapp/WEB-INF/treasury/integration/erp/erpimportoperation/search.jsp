...
<div class="page-header">
    <h1>
        <spring:message
            code="label.integration.erp.searchERPImportOperation" />
        <small></small>
    </h1>
</div>
<%-- NAVIGATION --%>
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>&nbsp;<a
        class=""
        href="${pageContext.request.contextPath}/treasury/integration/erp/erpimportoperation/create"><spring:message
    ...
    <form method="get" class="form-horizontal">
        <div class="panel-body">
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.ERPImportOperation.success" />
                </div>
...
<c:choose>
    <c:when test="${not empty searcherpimportoperationResultsDataSet}">
        ...
        <form id="deletemultiple"
            action="${pageContext.request.contextPath}/treasury/integration/erp/erpimportoperation/search/deletemultiple"

...
<div class="page-header">
    <h1>
        <spring:message code="label.integration.erp.readERPExportOperation" />
        <small></small>
    </h1>
</div>
        ...
        <div class="modal-content">
            <form id="deleteForm" action="${pageContext.request.contextPath}/treasury/integration/erp/erpexportoperation/delete/${eRPExportOperation.externalId}" method="POST">
                ...
                <div class="modal-body">
                    <p>
                        <spring:message code="label.integration.erp.readERPExportOperation.confirmDelete" />
                    </p>
                </div>
...
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/integration/erp/erpexportoperation/"><spring:message
...
<!--                     </tr> -->
                    <tr>
                        ...
                        <td><c:out value='${eRPExportOperation.errorLog}' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message code="label.ERPExportOperation.integrationLog" /></th>
                        <td><c:out value='${eRPExportOperation.integrationLog}' /></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <ul>
                                <c:forEach items="${eRPExportOperation.finantialDocuments}" var="element">
                                    <li><c:out value="${element.uiDocumentNumber}" /></li>
                                </c:forEach>
                                <ul>
                        </td>
                    </tr>

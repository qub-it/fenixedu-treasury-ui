...
<div class="page-header">
	<h1><spring:message code="label.integration.erp.updateERPConfiguration" />
		<small></small>
	</h1>
</div>
...
<div class="col-sm-2 control-label"><spring:message code="label.ERPConfiguration.exportAnnulledRelatedDocuments"/></div> 

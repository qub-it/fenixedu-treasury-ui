...
<div class="page-header">
	<h1><spring:message code="label.viewCustomerTreasuryEvents.searchTreasuryEvents" />
		<small></small>
	</h1>
</div>
<%-- NAVIGATION --%>
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/accounting/managecustomer/debtaccount/read/${debtAccount.externalId}"   ><spring:message code="label.event.back"/></a>
|&nbsp;&nbsp;</div>
...
<c:choose>
	<c:when test="${not empty searchtreasuryeventsResultsDataSet}">
		<table id="searchtreasuryeventsTable" class="table responsive table-bordered table-hover">
			<thead>
				<tr>
					<%--!!!  Field names here --%>
<th><spring:message code="label.TreasuryEvent.description"/></th>
<%-- Operations Column --%>
					<th></th>
				</tr>
			</thead>

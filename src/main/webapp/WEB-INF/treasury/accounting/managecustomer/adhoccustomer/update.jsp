...
<div class="page-header">
    <h1>
        <spring:message
            code="label.accounting.manageCustomer.updateAdhocCustomer" />
        <small></small>
    </h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
        class=""
        href="${pageContext.request.contextPath}/treasury/accounting/managecustomer/customer/read/${adhocCustomer.externalId}"><spring:message
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.AdhocCustomer.identificationNumber" />
                </div>

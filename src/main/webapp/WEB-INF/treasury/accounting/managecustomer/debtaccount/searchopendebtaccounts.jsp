...
<div class="page-header">
	<h1><spring:message code="label.accounting.managecustomer.searchOpenDebtAccounts" />
		<small></small>
	</h1>
</div>
<%-- NAVIGATION --%>
...
<script>
	var searchopendebtaccountsDataSet = [
			<c:forEach items="${searchopendebtaccountsResultsDataSet}" var="searchResult">
...
" <a  class=\"btn btn-default btn-xs\" href=\"${pageContext.request.contextPath}/treasury/accounting/managecustomer/debtaccount/searchopendebtaccountssearchOpenDebtAccounts/view/${searchResult.externalId}\"><spring:message code='label.view'/></a>" +
	...
	$(document).ready(function() {
		...
		var table = $('#searchopendebtaccountsTable').DataTable({language : {
...
//"dom": '<"col-sm-6"l>rtip', // FilterBox = NO && ExportOptions = NO
		...
		table.columns.adjust().draw();
		  ...
		  $('#searchopendebtaccountsTable tbody').on( 'click', 'tr', function () {

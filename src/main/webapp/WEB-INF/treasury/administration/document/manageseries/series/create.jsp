...
<div class="page-header">
	<h1><spring:message code="label.administration.document.manageSeries.createSeries" />
		<small></small>
	</h1>
</div>
...
<div class="col-sm-4">
	<%-- Relation to side 1 drop down rendered in input --%>
		 <select id="series_finantialInstitution" class="js-example-basic-single" name="finantialinstitution">
...
<div class="col-sm-4">
		 ...
		 <select id="series_bennu" class="js-example-basic-single" name="bennu">
		 <option value=""></option>  
		</select>
				</div>
</div>	
...
$(document).ready(function() {
	    ...
	    //$("#series_finantialInstitution").select2().select2('val', '<c:out value='${param.finantialinstitution}'/>');
	    ...
	    $("#series_bennu").select2().select2('val', '<c:out value='${param.bennu}'/>');

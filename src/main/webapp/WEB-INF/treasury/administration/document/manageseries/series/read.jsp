...
<div class="page-header">
    <h1>
        <spring:message code="label.administration.document.manageSeries.readSeries" />
        <small></small>
    </h1>
</div>
        ...
        <div class="modal-content">
            <form id="deleteForm" action="${pageContext.request.contextPath}/treasury/administration/document/manageseries/series/delete/${series.externalId}" method="POST">
                ...
                <div class="modal-body">
                    <p>
                        <spring:message code="label.administration.document.manageSeries.readSeries.confirmDelete" />
                    </p>
                </div>
...
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class=""
        href="${pageContext.request.contextPath}/treasury/administration/document/manageseries/series/"><spring:message code="label.event.back" /></a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><c:if test="${series.externSeries}">
                            ...
                            <c:if test="${not series.externSeries}">
                    ...
                    <tr>
                        ...
                        <td><c:if test="${series.certificated}">
                            ...
                            <c:if test="${not series.certificated}">
                                <spring:message code="label.false" />
                            </c:if></td>
                    </tr>
                    <tr>
            ...
            <tbody>
                <c:forEach items="${series.documentNumberSeriesSet}" var="documentNumberSeries">
                    <tr>
                        ...
                        <td><c:out value="${documentNumberSeries.sequenceNumber}" /></td>
                        <td>
                            <!--  ACTIONS -->
                        </td>
                    </tr>

...
<div class="page-header">
	<h1><spring:message code="label.administration.document.manageSeries.readSeries" />
		<small></small>
	</h1>
</div>
<div class="modal fade" id="deleteModal">
  <div class="modal-dialog">
    ...
    <form id ="deleteForm" action="${pageContext.request.contextPath}/treasury/administration/document/manageseries/series/delete/${series.externalId}"   method="POST">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><spring:message code="label.confirmation"/></h4>
      </div>
      <div class="modal-body">
        <p><spring:message code = "label.administration.document.manageSeries.readSeries.confirmDelete"/></p>
      </div>
...
<div class="well well-sm" style="display:inline-block">
 	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/administration/document/manageseries/series/"  ><spring:message code="label.event.back" /></a>
...
<!-- 				|&nbsp;&nbsp; -->
<%-- 	<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/administration/document/manageseries/series/update/${series.externalId}"  ><spring:message code="label.event.update" /></a> --%>
<!-- |&nbsp;&nbsp; -->
</div> 
...
<tr>
	...
	<td>
		<c:out value='${series.code}'/>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.Series.name"/></th> 
	<td>
		<c:out value='${series.name.content}'/>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.Series.externSeries"/></th> 
	<td>
		<c:if test="${series.externSeries}"><spring:message code="label.true" /></c:if><c:if test="${not series.externSeries}"><spring:message code="label.false" /></c:if>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.Series.certificated"/></th> 
	<td>
		<c:if test="${series.certificated}"><spring:message code="label.true" /></c:if><c:if test="${not series.certificated}"><spring:message code="label.false" /></c:if>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.Series.legacy"/></th> 
	<td>
		<c:if test="${series.legacy}"><spring:message code="label.true" /></c:if><c:if test="${not series.legacy}"><spring:message code="label.false" /></c:if>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.Series.finantialInstitution"/></th> 
	<td>
		<c:out value='${series.finantialInstitution}'/>
	</td> 
</tr>
<!-- <tr> -->
<%-- 	<th scope="row" class="col-xs-3"><spring:message code="label.Series.bennu"/></th> --%>
<!-- 	<td> -->
<%-- 		<c:out value='${series.bennu}'/> --%>
<!-- 	</td>  -->
<!-- </tr> -->
</tbody>
</table>
...
<th><spring:message code="label.DocumentNumberSeries.TotalDocuments"/></th>
<%-- Operations Column --%>
					<th></th>
				</tr>
			</thead>

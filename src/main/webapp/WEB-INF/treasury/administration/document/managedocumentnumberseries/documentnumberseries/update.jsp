...
<div class="page-header">
	<h1>
		<spring:message
			code="label.administration.document.manageDocumentNumberSeries.updateDocumentNumberSeries" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
		class=""
		href="${pageContext.request.contextPath}/treasury/administration/document/managedocumentnumberseries/documentnumberseries/read/${documentNumberSeries.externalId}"><spring:message
	...
	$("#documentNumberSeries_series").select2(
		{
		    ...
		    $("#documentNumberSeries_series").select2().select2('val', '<c:out value='${not empty param.series ? param.series : documentNumberSeries.series.externalId }'/>');

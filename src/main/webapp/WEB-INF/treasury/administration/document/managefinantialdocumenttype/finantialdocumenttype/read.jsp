...
<div class="page-header">
	<h1><spring:message code="label.administration.document.manageFinantialDocumentType.readFinantialDocumentType" />
		<small></small>
	</h1>
</div>
<div class="modal fade" id="deleteModal">
  <div class="modal-dialog">
    ...
    <form id ="deleteForm" action="${pageContext.request.contextPath}/treasury/administration/document/managefinantialdocumenttype/finantialdocumenttype/delete/${finantialDocumentType.externalId}"   method="POST">
...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/administration/document/managefinantialdocumenttype/finantialdocumenttype/"  ><spring:message code="label.event.back" /></a>
...
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.FinantialDocumentType.code"/></th> 
	<td>
		<c:out value='${finantialDocumentType.code}'/>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.FinantialDocumentType.name"/></th> 
	<td>
		<c:out value='${finantialDocumentType.name.content}'/>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.FinantialDocumentType.documentNumberSeriesPrefix"/></th> 
	<td>
		<c:out value='${finantialDocumentType.documentNumberSeriesPrefix}'/>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.FinantialDocumentType.invoice"/></th> 
	<td>

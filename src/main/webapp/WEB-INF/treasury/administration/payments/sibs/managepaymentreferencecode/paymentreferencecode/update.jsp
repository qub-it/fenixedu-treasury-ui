...
<div class="page-header">
    <h1>
        <spring:message
            code="label.administration.payments.sibs.managePaymentReferenceCode.updatePaymentReferenceCode" />
        <small></small>
    </h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
        class=""
        href="${pageContext.request.contextPath}/treasury/administration/payments/sibs/managepaymentreferencecode/paymentreferencecode/read/${paymentReferenceCode.externalId}"><spring:message
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input id="paymentReferenceCode_referenceCode"
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.PaymentReferenceCode.beginDate" />
                </div>

                <div class="col-sm-4">
                    <input id="paymentReferenceCode_beginDate"
                        class="form-control" type="text"
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.PaymentReferenceCode.endDate" />
                </div>

                <div class="col-sm-4">
                    <input id="paymentReferenceCode_endDate"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <select id="paymentReferenceCode_state"

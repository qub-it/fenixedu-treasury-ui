...
<option value="true"><spring:message code="label.yes"/></option>				
	...
	<script>$("#paymentCodePool_useAmountToValidateCheckDigit").val('<c:out value='${not empty param.useamounttovalidatecheckdigit ? param.useamounttovalidatecheckdigit : paymentCodePool.useAmountToValidateCheckDigit }'/>');</script>	
</div>
</div>
        </div>

...
<div class="page-header">
	<h1><spring:message code="label.administration.payments.sibs.manageSibsInputFile.createSibsInputFile" />
		<small></small>
	</h1>
</div>
...
$(document).ready(function() {
    ...
    $("#sibsInputFile_uploader").select2().select2('val', '<c:out value='${param.uploader}'/>');

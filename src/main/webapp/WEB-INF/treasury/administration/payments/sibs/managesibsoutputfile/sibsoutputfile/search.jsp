...
<div class="page-header">
    <h1><spring:message code="label.administration.payments.sibs.manageSibsOutputFile.searchSibsOutputFile" />
        <small></small>
    </h1>
</div>
<%-- NAVIGATION --%>
    ...
    <c:when test="${not empty searchsibsoutputfileResultsDataSet}">
        <table id="searchsibsoutputfileTable" class="table responsive table-bordered table-hover" width="100%">
            <thead>
                <tr>
                    <%--!!!  Field names here --%>
                    <th><spring:message code="label.SibsOutputFile.whenUploaded"/></th>
<th><spring:message code="label.SibsOutputFile.uploader"/></th>
<%-- Operations Column --%>
                    <th></th>
                </tr>
            </thead>
...
<script>
    var searchsibsoutputfileDataSet = [
            <c:forEach items="${searchsibsoutputfileResultsDataSet}" var="searchResult">
...
" <a  class=\"btn btn-default btn-xs\" href=\"${pageContext.request.contextPath}/treasury/administration/payments/sibs/managesibsoutputfile/sibsoutputfile/search/view/${searchResult.externalId}\"><spring:message code='label.view'/></a>" +
    ...
    $(document).ready(function() {
        ...
        var table = $('#searchsibsoutputfileTable').DataTable({language : {
...
{ data: 'whencreated' },
        ...
        "data" : searchsibsoutputfileDataSet,
...
//"dom": '<"col-sm-6"l>rtip', // FilterBox = NO && ExportOptions = NO
        ...
        table.columns.adjust().draw();
          ...
          $('#searchsibsoutputfileTable tbody').on( 'click', 'tr', function () {

...
<form method="post" class="form-horizontal" enctype="multipart/form-data">
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <!-- </div>		 -->
            <div class="form-group row">
            <div class="col-sm-2 control-label"><spring:message code="label.SibsReportFile.uploadFile"/></div> 
            <div class="col-sm-10">
               <input type="file" name="documentSibsReportFile" accept="${ allowedFileType}" required />
            </div> 
            </div>     
        </div>

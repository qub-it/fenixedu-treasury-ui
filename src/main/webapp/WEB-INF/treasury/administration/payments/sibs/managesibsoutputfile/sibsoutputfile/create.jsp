...
<div class="page-header">
    <h1>
        <spring:message code="label.administration.payments.sibs.manageSibsOutputFile.createSibsOutputFile" />
        <small></small>
    </h1>
</div>
        ...
        <div class="panel-body">
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message code="label.SibsOutputFile.lastSuccessfulExportation" />
                </div>

                <div class="col-sm-4">
                    <input id="sibsOutputFile_lastSuccessfulExportation" class="form-control" type="text" name="lastsuccessfulexportation" bennu-datetime

...
<div class="page-header">
    <h1>
        <spring:message
            code="label.administration.payments.sibs.manageSibsReportFile.readSibsReportFile" />
        <small></small>
    </h1>
</div>
<div class="modal fade" id="deleteModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteForm"
                action="${pageContext.request.contextPath}/treasury/administration/payments/sibs/managesibsreportfile/sibsreportfile/delete/${sibsReportFile.externalId}"
                method="POST">
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><c:out
                                value='${sibsReportFile.transactionsTotalAmount}' />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message

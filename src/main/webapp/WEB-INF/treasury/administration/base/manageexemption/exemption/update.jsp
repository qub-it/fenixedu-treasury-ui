...
<div class="page-header">
	<h1><spring:message code="label.administration.base.manageExemption.updateExemption" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/administration/base/manageexemption/exemption/read/${exemption.externalId}" ><spring:message code="label.event.back" /></a>
|&nbsp;&nbsp;</div>
...
<div class="col-sm-10">
<input id="exemption_name" class="form-control" type="text" name="name"  bennu-localized-string value='${not empty param.name ? param.name : exemption.name.json() } '/> 
</div>
</div>		
<div class="form-group row">

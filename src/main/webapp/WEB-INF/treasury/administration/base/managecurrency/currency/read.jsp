...
<div class="page-header">
	<h1><spring:message code="label.administration.base.manageCurrency.readCurrency" />
		<small></small>
	</h1>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p><spring:message code = "label.administration.base.manageCurrency.readCurrency.confirmDelete"/></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><spring:message code = "label.close"/></button>
        <a class="btn btn-danger" href="${pageContext.request.contextPath}/treasury/administration/base/managecurrency/currency/delete/${currency.externalId}"  > <spring:message code = "label.delete"/></a>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
data-target="#deleteModal"><spring:message code="label.event.delete" /></a>
				|&nbsp;&nbsp;
	<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/administration/base/managecurrency/currency/update/${currency.externalId}"  ><spring:message code="label.event.update" /></a>
|&nbsp;&nbsp;</div>
...
<table class="table">
		<tbody>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.Currency.code"/></th> 
	<td>
		<c:out value='${currency.code}'/>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.Currency.name"/></th> 
	<td>
		<c:out value='${currency.name.content}'/>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.Currency.isoCode"/></th> 
	<td>
		<c:out value='${currency.isoCode}'/>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.Currency.symbol"/></th> 
	<td>

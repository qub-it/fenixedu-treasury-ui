...
<div class="modal fade" id="deleteModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="deleteForm" action="${pageContext.request.contextPath}/treasury/administration/base/managefixedtariff/fixedtariff/delete/${fixedTariff.externalId}" method="POST">
			...
			<table class="table">
				<tbody>
					...
					<tr>
						...
						<td><c:out value='${fixedTariff.vatType.name.content}' /></td>
					</tr>
					<tr>

...
<div class="page-header">
    <h1>
        <spring:message
            code="label.administration.base.manageFixedTariff.createFixedTariff" />
        <small></small>
    </h1>
</div>
...
<form name='form' method="post" class="form-horizontal"
    ...
    <input type="hidden" name="postback"
        value='${pageContext.request.contextPath}treasury/administration/base/managefixedtariff/fixedtariff/createpostback' />
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input required id="fixedTariff_beginDate"
                        class="form-control" type="text"
                        name="beginDate" bennu-date="object.beginDate" />
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                ...
                <div class="col-sm-4">
                    <input required id="fixedTariff_endDate"
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.FixedTariff.finantialEntity" />
                </div>

                <div class="col-sm-4">
                    <%-- Relation to side 1 drop down rendered in input --%>
                    <ui-select id="fixedTariff_finantialEntity"
                        name="finantialentity"
                        ng-model="$parent.object.finantialEntity"
                        theme="bootstrap" ng-disabled="disabled">
                    <ui-select-match>{{$select.selected.text}}</ui-select-match>
                    <ui-select-choices
                        repeat="finantialEntity.id as finantialEntity in object.finantialEntityDataSource | filter: $select.search">
                    <span
                        ng-bind-html="finantialEntity.text | highlight: $select.search"></span>
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.FixedTariff.dueDateCalculationType" />
                </div>

                <div class="col-sm-4">
                    <ui-select id="fixedTariff_dueDateCalculationType"
                        name="duedatecalculationtype"
                        ng-model="$parent.object.dueDateCalculationType"
                        ng-disabled="disabled" reset-search-input="true">
                    <ui-select-match>{{$select.selected.text}}</ui-select-match>
                    <ui-select-choices
            ...
            <div class="form-group row"
                ng-show="object.dueDateCalculationType == 'FIXED_DATE'">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.FixedTariff.fixedDueDate" />
                </div>

                <div class="col-sm-4">
                    <input id="fixedTariff_fixedDueDate"
                        class="form-control" type="text"
                        name="fixedDueDate"
                        bennu-date="object.fixedDueDate" />
                </div>
            </div>
            <div class="form-group row"
                ng-show="object.dueDateCalculationType == 'DAYS_AFTER_CREATION'">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.FixedTariff.numberOfDaysAfterCreationForDueDate" />
                </div>

                <div class="col-sm-10">
                    <input
                        id="fixedTariff_numberOfDaysAfterCreationForDueDate"
                        class="form-control" type="text"
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.FixedTariff.applyInterests" />
                </div>
                <div class="col-sm-2">
                    <select id="fixedTariff_applyInterests"
            ...
            <div class="form-group row" ng-show="object.applyInterests">
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.FixedTariff.interestType" />
                </div>

                <div class="col-sm-4">
                    <%-- Relation to side 1 drop down rendered in input --%>
                    <ui-select id="fixedTariff_interestType"
                        name="vattype"
                        ng-model="$parent.object.interestRate.interestType"
                        theme="bootstrap" ng-disabled="disabled">
                    <ui-select-match>{{$select.selected.text}}</ui-select-match>
                    <ui-select-choices
                        repeat="interestType.id as interestType in object.interestRate.interestTypeDataSource | filter: $select.search">
                    <span
                        ng-bind-html="interestType.text | highlight: $select.search"></span>
                    </ui-select-choices> </ui-select>
                </div>
            </div>
            <div class="form-group row"
                ...
                <div class="col-sm-2 control-label">
                    <spring:message
                        code="label.InterestRate.numberOfDaysAfterDueDate" />
                </div>
                <div class="col-sm-4">
                    <input id="fixedTariff_numberOfDaysAfterDueDate"
                        class="form-control" type="text"
                        ng-model="object.interestRate.numberOfDaysAfterDueDate"
            ...
            <div class="form-group row"
                ng-show="object.interestRate.interestType != 'FIXED_AMOUNT' && object.applyInterests">
                <div class="col-sm-2 control-label">
                    <spring:message code="label.InterestRate.rate" />
                </div>
                <div class="col-sm-4">
                    <input id="fixedTariff_rate" class="form-control"
                        type="text" ng-model="object.interestRate.rate"
                        name="rate" pattern="^100(\.0{1,2})?|[0-9]{1,2}(\.[0-9]{1,2})?$" />
                </div>
            </div>

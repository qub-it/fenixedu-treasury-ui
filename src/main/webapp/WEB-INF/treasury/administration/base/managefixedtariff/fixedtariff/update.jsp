...
<div class="page-header">
	<h1>
		<spring:message code="label.administration.base.manageFixedTariff.updateFixedTariff" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class=""
		href="${pageContext.request.contextPath}/treasury/administration/base/manageproduct/product/read/${fixedTariff.product.externalId}"><spring:message code="label.event.back" /></a>
	&nbsp;|&nbsp;
</div>
...
<form name='form' method="post" class="form-horizontal" ng-app="angularAppFixedTariff" ng-controller="FixedTariffController"
	...
	<input type="hidden" name="postback" value='${pageContext.request.contextPath}treasury/administration/base/managefixedtariff/fixedtariff/updatepostback/${fixedTariff.externalId}' />
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input required id="fixedTariff_amount" class="form-control" type="text" pattern="[0-9]+(\.[0-9][0-9]?[0-9]?)?" ng-model="object.amount" name="amount"
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					...
					<ui-select id="fixedTariff_finantialEntity" name="finantialentity" ng-model="$parent.object.finantialEntity" theme="bootstrap" ng-disabled="disabled"> <ui-select-match>{{$select.selected.text}}</ui-select-match>
					<ui-select-choices repeat="finantialEntity.id as finantialEntity in object.finantialEntityDataSource | filter: $select.search"> <span
			...
			<div class="form-group row" ng-show="object.applyInterests">
				...
				<div class="col-sm-4">
					<%-- Relation to side 1 drop down rendered in input --%>
					<ui-select id="fixedTariff_interestType" name="vattype" ng-model="$parent.object.interestRate.interestType" theme="bootstrap" ng-disabled="disabled"> <ui-select-match>{{$select.selected.text}}</ui-select-match>
					<ui-select-choices repeat="interestType.id as interestType in object.interestRate.interestTypeDataSource | filter: $select.search"> <span
			...
			<div class="form-group row" ng-show="object.applyInterests && object.interestRate.interestType=='MONTHLY'">
				...
				<div class="col-sm-4">
					<input id="fixedTariff_maximumMonthsToApplyPenalty" class="form-control" type="text" ng-model="object.interestRate.maximumMonthsToApplyPenalty"

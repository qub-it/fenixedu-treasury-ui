...
<div class="page-header">
	<h1><spring:message code="label.administration.base.manageProduct.updateProduct" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/administration/base/manageproduct/product/read/${product.externalId}" ><spring:message code="label.event.back" /></a>
|&nbsp;&nbsp;</div>
...
<div class="col-sm-10">
<input id="product_unitOfMeasure" class="form-control" type="text" name="unitofmeasure"  bennu-localized-string value='${not empty param.unitofmeasure ? param.unitofmeasure : product.unitOfMeasure.json() } '/> 
</div>
</div>		
<div class="form-group row">

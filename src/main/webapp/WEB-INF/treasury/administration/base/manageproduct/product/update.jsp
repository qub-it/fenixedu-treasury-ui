...
<div class="page-header">
	<h1>
		<spring:message
			code="label.administration.base.manageProduct.updateProduct" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
		class=""
		href="${pageContext.request.contextPath}/treasury/administration/base/manageproduct/product/read/${product.externalId}"><spring:message
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select id="product_productGroup" class="js-example-basic-single"
						name="productGroup" required>
					</select>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input id="product_name" class="form-control" type="text"
						...
						value='${not empty param.name ? param.name : product.name.json() } ' />
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-2 control-label">

...
<div class="page-header">
	<h1>
		<spring:message code="label.administration.base.manageProduct.readProduct" />
		<small></small>
	</h1>
</div>
				...
				<tbody>
					...
					<tr>
						...
						<td><c:if test="${product.active}">
							...
							</c:if> <c:if test="${not product.active}">
...
<c:choose>
	<c:when test="${not empty product.finantialInstitutionsSet}">
		<c:forEach items="${ product.finantialInstitutionsSet}" var="finantialInstitution">
			<h3>
				...
				<c:when test="${not empty product.getFixedTariffsSet(finantialInstitution)}">
					<datatables:table id="activeTariffs${finantialInstitution.externalId}" row="tariff" data="${product.getFixedTariffsSet(finantialInstitution)}"
						...
						<datatables:column>
							...
							<c:out value="${tariff.finantialEntity.name.content}" />
						</datatables:column>
						<datatables:column>
							<datatables:columnHead>

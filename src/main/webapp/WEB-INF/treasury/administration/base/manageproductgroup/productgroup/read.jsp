...
<div class="page-header">
	<h1><spring:message code="label.administration.base.manageProductGroup.readProductGroup" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/administration/base/manageproductgroup/productgroup/"  ><spring:message code="label.event.back" /></a>
...
data-target="#deleteModal"><spring:message code="label.event.delete" /></a>
				|&nbsp;&nbsp;
	<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/treasury/administration/base/manageproductgroup/productgroup/update/${productGroup.externalId}"  ><spring:message code="label.event.update" /></a>
|&nbsp;&nbsp;</div>
...
<table class="table">
		<tbody>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.ProductGroup.code"/></th> 
	<td>
		<c:out value='${productGroup.code}'/>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.ProductGroup.name"/></th> 
	<td>
		<c:out value='${productGroup.name.content}'/>
	</td> 
</tr>
</tbody>
</table>

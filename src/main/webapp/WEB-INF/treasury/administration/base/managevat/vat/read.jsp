...
<div class="page-header">
	<h1>
		<spring:message code="label.administration.base.manageVat.readVat" />
		<small></small>
	</h1>
</div>
	...
	<div class="panel-body">
		<form method="post" class="form-horizontal">
			<table class="table">
				<tbody>
					<tr>
						<th scope="row" class="col-xs-3"><spring:message code="label.Vat.finantialInstitution" /></th>
						<td><c:out value='${vat.finantialInstitution.name}' /></td>
					</tr>
					<tr>
						<th scope="row" class="col-xs-3"><spring:message code="label.Vat.vatType" /></th>
						<td><c:out value='${vat.vatType.name.content}' /></td>
					</tr>
					<tr>

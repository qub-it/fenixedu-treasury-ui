...
<div class="page-header">
	<h1>
		<spring:message code="label.administration.base.manageVat.updateVat" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class=""
		href="${pageContext.request.contextPath}/treasury/administration/base/managevat/vat/read/${vat.externalId}"><spring:message code="label.event.back" /></a> |&nbsp;&nbsp;
</div>
...
<!-- 				<div class="col-sm-10"> -->
<!-- 					<select id="vat_vatExemptionReason" class="js-example-basic-single" name="vatExemptionReason"> -->
<!-- 						<option value=""></option> -->
<!-- 					</select> -->
<!-- 				</div> -->
<!-- 			</div> -->
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<input id="vat_taxRate" class="form-control" type="text" pattern="[0-9]+(\.[0-9][0-9]?[0-9]?)?" name="taxrate"
						value='<c:out value='${not empty param.taxrate ? param.taxrate : vat.taxRate }'/>' required />
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-2 control-label">

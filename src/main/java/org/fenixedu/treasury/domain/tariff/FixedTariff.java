...
public class FixedTariff extends FixedTariff_Base {
    ...
    protected FixedTariff(final FinantialEntity finantialEntity, final Product product, final VatType vatType, final DateTime beginDate, final DateTime endDate,
    ...
    protected void init(final FinantialEntity finantialEntity, final Product product, final VatType vatType, final DateTime beginDate, final DateTime endDate, final BigDecimal amount,

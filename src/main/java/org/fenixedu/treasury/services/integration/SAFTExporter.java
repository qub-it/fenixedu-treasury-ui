...
//					+ institution.getCode());
//			List<Customer> allCustomers = institution.getDebtAccountsSet()
//					.stream().map(x -> x.getCustomer())
//					.collect(Collectors.toList());
//			List<Product> allProducts = institution.getProductsSet();
//
...
//
//		List<VatType> allVatsInStore = institution.getVats();
//
...
//							document.getFinantialDocumentType()
...
//					} else if (SAFTDocumentType.INVOICE().equals(
//							document.getDocumentType().getSAFTType())) {
...
//					} else if (Boolean.FALSE.equals(document
//							.getFinantialDocumentType().isInvoice())) {
...
//	}
//
//	private Tax getSAFTWorkingDocumentsTax(Product product) {
//		Tax tax = new Tax();
//
//		VatType vat = product.getVatType();
//		// Tax-TaxCode
//
//		if (vat.getCode().equals("4")) {
//			tax.setTaxCode("INT");
...
//			header.setProductCompanyTaxID(SolutionConfig.SAFT
...
//			 */
//			header.setProductID(SolutionConfig.SAFT.PRODUCT_ID());
//
//			// Product Version
//			header.setProductVersion(SolutionConfig.SAFT.PRODUCT_VERSION());
//
//			// SoftwareCertificateNumber
//			header.setSoftwareCertificateNumber(BigInteger
//					.valueOf(SolutionConfig.SAFT.SOFTWARE_CERTIFICATE_NUMBER()));
//
//			// StartDate
...
//			saftExporter.generateSaft(store, fromDate, toDate, operation,
//					documents, true);
//
//		} catch (Throwable t) {
...
//	}
//
//	private void writeSaftFile(String content, SaftExportOperation operation) {
//		byte[] bytes = null;
//		try {
...
//			e.printStackTrace();
//		}
//		BinaryStream binaryStream = new BinaryStream(bytes);
...
//	}
//
//	public static void exportMovementOfGoods(String username, Store store,
//			DateTime fromDate, DateTime toDate) {
//
//		// if (!deliveryNotesNotValidated.isEmpty()) {
//		List<DeliveryNote> deliveryNotesNotValidated = finantialInstitution
//				.getDeliveryNotesNotValidated(fromDate, toDate);
//		Collections.sort(deliveryNotesNotValidated,
//				DeliveryNote.WHEN_CREATED_COMPARATOR);
//		SaftExportOperation operation = createSaftExportOperation(
//				finantialInstitution.getSapCode(), fromDate, toDate, username,
//				SaftFileType.MOVEMENT_OF_GOODS());
//		try {
//			SAFTExporter saftExporter = new SAFTExporter();
//			saftExporter.generateSaft(store, fromDate, toDate, operation,
//					deliveryNotesNotValidated, false);
//
//		} catch (Throwable t) {
//			writeError(operation, t);
//		}

...
//				
    ...
    public String createpaymentcodeindebitnote(Model model) {
...
//				public static final String  CREATEPAYMENTCODEINDEBITNOTEPOSTBACK_URL = CONTROLLER_URL + _CREATEPAYMENTCODEINDEBITNOTEPOSTBACK_URI;
...
//  			  	public @ResponseBody String createpaymentcodeindebitnotepostback(@RequestParam(value = "bean", required = false) PaymentReferenceCodeBean bean,
//            		Model model) {
//
//        			// Do validation logic ?!?!
//        			this.setPaymentReferenceCodeBean(bean, model);
...
//					model.addAttribute("paymentReferenceCode",paymentReferenceCode);
//				    return redirect("/treasury/document/manageinvoice/debitnote/read/" + getPaymentReferenceCode(model).getExternalId(), model, redirectAttributes);
//					}
//					catch (Exception de)
//					{
//
...
//				
    ...
    public String createpaymentcodeindebitnote(@RequestParam(value = "paymentCodePool") PaymentCodePool paymentCodePool,
            @RequestParam(value = "debitNote") DebitNote debitNote, Model model, RedirectAttributes redirectAttributes) {
        /*
        *  Creation Logic
        */
        ...
        try {
            ...
            PaymentReferenceCode paymentReferenceCode =
                    paymentCodePool.getReferenceCodeGenerator().generateNewCodeFor(debitNote.getDebtAccount().getCustomer(),
                            debitNote.getOpenAmount());

            paymentReferenceCode.createPaymentTargetTo(debitNote);
            //Success Validation
            //Add the bean to be used in the View
            ...
            return createpaymentcodeindebitnote(model);
        }
    }
//    @Atomic

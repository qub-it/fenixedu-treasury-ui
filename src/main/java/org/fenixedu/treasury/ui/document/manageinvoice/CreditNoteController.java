...
public class CreditNoteController extends TreasuryBaseController {
    ...
    public String search(
        ...
        model.addAttribute("CreditNote_payorDebtAccount_options", new ArrayList<org.fenixedu.treasury.domain.debt.DebtAccount>()); // CHANGE_ME
                                                                                                                                   // -
                                                                                                                                   // MUST
                                                                                                                                   // DEFINE
                                                                                                                                   // RELATION
        ...
        // // CHANGE_ME - MUST DEFINE RELATION
        model.addAttribute("CreditNote_debtAccount_options", new ArrayList<org.fenixedu.treasury.domain.debt.DebtAccount>()); // CHANGE_ME
                                                                                                                              // -
                                                                                                                              // MUST
                                                                                                                              // DEFINE
                                                                                                                              // RELATION
        ...
        // // CHANGE_ME - MUST DEFINE RELATION
        model.addAttribute("CreditNote_currency_options", new ArrayList<org.fenixedu.treasury.domain.Currency>()); // CHANGE_ME
                                                                                                                   // -
                                                                                                                   // MUST
                                                                                                                   // DEFINE
                                                                                                                   // RELATION
    ...
    private List<CreditNote> filterSearchCreditNote(org.fenixedu.treasury.domain.document.DebitNote debitNote,
        ...
        return getSearchUniverseSearchCreditNoteDataSet()
                ...
                .filter(creditNote -> documentNumber == null
                        ...
                        || (creditNote.getDocumentNumber() != null && creditNote.getDocumentNumber().length() > 0 && creditNote
                ...
                .filter(creditNote -> originDocumentNumber == null
                        ...
                        || (creditNote.getOriginDocumentNumber() != null && creditNote.getOriginDocumentNumber().length() > 0 && creditNote
    ...
    public CreditNote createCreditNote(org.fenixedu.treasury.domain.document.DebitNote debitNote,
        ...
        CreditNote creditNote = CreditNote.create(payorDebtAccount, documentNumberSeries, documentDate);
        return creditNote;
    }
    ...
    public String update(
        ...
        try {
            ...
            updateCreditNote(debitNote, payorDebtAccount, finantialDocumentType, debtAccount, documentNumberSeries, currency,
                    documentNumber, documentDate, documentDueDate, originDocumentNumber, state, model);

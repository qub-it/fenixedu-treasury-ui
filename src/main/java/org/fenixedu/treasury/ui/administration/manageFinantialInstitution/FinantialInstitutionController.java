...
//				
					...
					,@RequestParam(value="district", required=false) 
										pt.ist.standards.geographic.District 
										  district
					,@RequestParam(value="minicipality", required=false) 
										pt.ist.standards.geographic.Municipality 
										  minicipality
					,@RequestParam(value="locality", required=false) 
										pt.ist.standards.geographic.Locality 
										  locality
					,@RequestParam(value="zipcode", required=false) 
										pt.ist.standards.geographic.PostalCode 
										  zipCode
					, Model model) {
							List<FinantialInstitution> searchfinantialinstitutionResultsDataSet = filterSearchFinantialInstitution(   code  ,   fiscalNumber  ,   companyId  ,   name  ,   companyName  ,   address  ,   country  ,   district  ,   minicipality  ,   locality  ,   zipCode  );
		...
		private List<FinantialInstitution> filterSearchFinantialInstitution( java.lang.String code 
		, java.lang.String fiscalNumber 
		, java.lang.String companyId 
		, java.lang.String name 
		, java.lang.String companyName 
		, java.lang.String address 
		, pt.ist.standards.geographic.Country country 
		, pt.ist.standards.geographic.District district 
		, pt.ist.standards.geographic.Municipality minicipality 
		, pt.ist.standards.geographic.Locality locality 
		, pt.ist.standards.geographic.PostalCode zipCode 
		) {
			
			return getSearchUniverseSearchFinantialInstitutionDataSet().stream()
				.filter(finantialInstitution -> code == null || 
					 code.length() == 0 ||  (finantialInstitution.getCode() != null && finantialInstitution.getCode().length() > 0 && finantialInstitution.getCode().toLowerCase().contains(code.toLowerCase())))
				.filter(finantialInstitution -> fiscalNumber == null || 
					 fiscalNumber.length() == 0 ||  (finantialInstitution.getFiscalNumber() != null && finantialInstitution.getFiscalNumber().length() > 0 && finantialInstitution.getFiscalNumber().toLowerCase().contains(fiscalNumber.toLowerCase())))
				.filter(finantialInstitution -> companyId == null || 
					 companyId.length() == 0 ||  (finantialInstitution.getCompanyId() != null && finantialInstitution.getCompanyId().length() > 0 && finantialInstitution.getCompanyId().toLowerCase().contains(companyId.toLowerCase())))
				.filter(finantialInstitution -> name == null || 
					 name.length() == 0 ||  (finantialInstitution.getName() != null && finantialInstitution.getName().length() > 0 && finantialInstitution.getName().toLowerCase().contains(name.toLowerCase())))
				.filter(finantialInstitution -> companyName == null || 
					 companyName.length() == 0 ||  (finantialInstitution.getCompanyName() != null && finantialInstitution.getCompanyName().length() > 0 && finantialInstitution.getCompanyName().toLowerCase().contains(companyName.toLowerCase())))
				.filter(finantialInstitution -> address == null || 
					 address.length() == 0 ||  (finantialInstitution.getAddress() != null && finantialInstitution.getAddress().length() > 0 && finantialInstitution.getAddress().toLowerCase().contains(address.toLowerCase())))
				...
				.filter(finantialInstitution -> minicipality == null || minicipality.equals(finantialInstitution.getMinicipality()))
...
//
		...
		return "redirect:/treasury/administration/managefinantialinstitution/finantialinstitution/";
						...
						return "treasury/administration/managefinantialinstitution/finantialinstitution/read/" + getFinantialInstitution(model).getExternalId();
					}  
//				
...
//				
				...
				, Model model ) {
					...
					*/
				     ...
				     FinantialInstitution finantialInstitution = createFinantialInstitution(   code  ,   fiscalNumber  ,   companyId  ,   name  ,   companyName  ,   address  ,   country  ,   district  ,   minicipality  ,   locality  ,   zipCode  );
...
return "redirect:/treasury/administration/managefinantialinstitution/finantialinstitution/read/" + getFinantialInstitution(model).getExternalId();
				...
				@Atomic
				public FinantialInstitution createFinantialInstitution( java.lang.String code 
				, java.lang.String fiscalNumber 
				, java.lang.String companyId 
				, java.lang.String name 
				, java.lang.String companyName 
				...
				, pt.ist.standards.geographic.PostalCode zipCode 
						 ...
						 * for each field
						 */
						FinantialInstitution finantialInstitution = new FinantialInstitution();
						 finantialInstitution.setCode(code);
						 finantialInstitution.setFiscalNumber(fiscalNumber);
						 finantialInstitution.setCompanyId(companyId);
						 finantialInstitution.setName(name);
						 finantialInstitution.setCompanyName(companyName);
						 finantialInstitution.setAddress(address);
						 finantialInstitution.setCountry(country);
						 finantialInstitution.setDistrict(district);
						 finantialInstitution.setMinicipality(minicipality);
						 finantialInstitution.setLocality(locality);
						 finantialInstitution.setZipCode(zipCode);
...
//				
				...
				public String update(@PathVariable("oid") FinantialInstitution finantialInstitution, @RequestParam(value="code", required=false) 
									java.lang.String 
									  code
				,@RequestParam(value="fiscalnumber", required=false) 
									java.lang.String 
				...
				, Model model) {
					...
					*/
				     ...
				     * Succes Update
				     */
					updateFinantialInstitution( code ,  fiscalNumber ,  companyId ,  name ,  companyName ,  address ,  country ,  district ,  minicipality ,  locality ,  zipCode ,  model);
...
return "redirect:/treasury/administration/managefinantialinstitution/finantialinstitution/read/" + getFinantialInstitution(model).getExternalId();
				...
				@Atomic
				public void updateFinantialInstitution(  java.lang.String code 
				, java.lang.String fiscalNumber 
				, java.lang.String companyId 
				, java.lang.String name 
				, java.lang.String companyName 
				...
				, pt.ist.standards.geographic.PostalCode zipCode 
				 ,  Model m) {
						 ...
						 */
						 getFinantialInstitution(m).setCode(code);
						 getFinantialInstitution(m).setFiscalNumber(fiscalNumber);
						 getFinantialInstitution(m).setCompanyId(companyId);
						 getFinantialInstitution(m).setName(name);
						 getFinantialInstitution(m).setCompanyName(companyName);
						 getFinantialInstitution(m).setAddress(address);
						 getFinantialInstitution(m).setCountry(country);
						 getFinantialInstitution(m).setDistrict(district);
						 getFinantialInstitution(m).setMinicipality(minicipality);
						 getFinantialInstitution(m).setLocality(locality);
						 getFinantialInstitution(m).setZipCode(zipCode);
				}

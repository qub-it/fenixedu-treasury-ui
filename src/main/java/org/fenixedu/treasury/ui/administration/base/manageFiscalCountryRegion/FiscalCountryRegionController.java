...
@SpringFunctionality(app = TreasuryController.class, title = "label.title.administration.base.manageFiscalCountryRegion",accessGroup = "anyone")// CHANGE_ME accessGroup = "group1 | group2 | groupXPTO"
...
//				
					...
					public String search(@RequestParam(value="regioncode", required=false) 
										java.lang.String 
										  regionCode
		...
		, org.fenixedu.commons.i18n.LocalizedString name 
			...
			return getSearchUniverseSearchFiscalCountryRegionDataSet().stream()
				.filter(fiscalCountryRegion -> regionCode == null || 
					 regionCode.length() == 0 ||  (fiscalCountryRegion.getRegionCode() != null && fiscalCountryRegion.getRegionCode().length() > 0 && fiscalCountryRegion.getRegionCode().toLowerCase().contains(regionCode.toLowerCase())))
					...
					|| name.getLocales()
							...
							.allMatch(
									locale -> fiscalCountryRegion.getName().getContent(locale) != null
											&& fiscalCountryRegion.getName().getContent(locale)
													.toLowerCase()
		...
		return "redirect:/treasury/administration/base/managefiscalcountryregion/fiscalcountryregion/read" + "/" + fiscalCountryRegion.getExternalId();
		}
...
//
		...
		return "redirect:/treasury/administration/base/managefiscalcountryregion/fiscalcountryregion/";
						...
						return "treasury/administration/base/managefiscalcountryregion/fiscalcountryregion/read/" + getFiscalCountryRegion(model).getExternalId();
					}  
//				
...
//				
				...
				public String create(@RequestParam(value="regioncode", required=false) 
									java.lang.String 
									  regionCode
				,@RequestParam(value="name", required=false) 
									org.fenixedu.commons.i18n.LocalizedString 
...
return "redirect:/treasury/administration/base/managefiscalcountryregion/fiscalcountryregion/read/" + getFiscalCountryRegion(model).getExternalId();
...
//				
				...
				public String update(@PathVariable("oid") FiscalCountryRegion fiscalCountryRegion, @RequestParam(value="regioncode", required=false) 
									java.lang.String 
									  regionCode
				,@RequestParam(value="name", required=false) 
									org.fenixedu.commons.i18n.LocalizedString 
...
return "redirect:/treasury/administration/base/managefiscalcountryregion/fiscalcountryregion/read/" + getFiscalCountryRegion(model).getExternalId();
				...
				@Atomic
				public void updateFiscalCountryRegion(  java.lang.String regionCode 
				, org.fenixedu.commons.i18n.LocalizedString name 
				 ,  Model m) {
						/*
						 ...
						 */
						 getFiscalCountryRegion(m).setRegionCode(regionCode);

...
@SpringFunctionality(app = TreasuryController.class, title = "label.title.accounting.manageDebtEntry",accessGroup = "anyone")// CHANGE_ME accessGroup = "group1 | group2 | groupXPTO"
//or

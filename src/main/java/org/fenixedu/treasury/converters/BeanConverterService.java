 ...
 */
package org.fenixedu.treasury.converters;
...
public class BeanConverterService implements ConditionalGenericConverter {
    ...
    public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
        return String.class.equals(sourceType.getType()) && ITreasuryBean.class.isAssignableFrom(targetType.getType());
    }

    @Override
    public Set<ConvertiblePair> getConvertibleTypes() {
        return Collections.singleton(new ConvertiblePair(String.class, ITreasuryBean.class));
    }
